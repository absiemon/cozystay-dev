export default function Perks({selected, onChange }) {
    ...
    const handleClick = (e)=>{
        ...
        //when we unchecked(remove from selected list)
    }
    return (
        <>
            <label className="border p-4 bg-white flex rounded-2xl gap-2 items-center cursor-pointer">
                <input checked={selected.includes('wifi')} name="wifi" type="checkbox" onChange={handleClick}></input>
            ...
            <label className="border p-4 bg-white flex rounded-2xl gap-2 items-center cursor-pointer">
                <input checked={selected.includes('parking')} name="parking" type="checkbox" onChange={handleClick}></input>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <label className="border p-4 bg-white flex rounded-2xl gap-2 items-center cursor-pointer">
                <input checked={selected.includes('tv')} name="tv" type="checkbox" onChange={handleClick}></input>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <label className="border p-4 bg-white flex rounded-2xl gap-2 items-center cursor-pointer">
                <input checked={selected.includes('radio')} name="radio" type="checkbox" onChange={handleClick}></input>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <label className="border p-4 bg-white flex rounded-2xl gap-2 items-center cursor-pointer">
                <input checked={selected.includes('pets')} name="pets" type="checkbox" onChange={handleClick}></input>
            ...
            <label className="border p-4 bg-white flex rounded-2xl gap-2 items-center cursor-pointer">
                <input checked={selected.includes('entrance')} name="entrance" type="checkbox" onChange={handleClick}></input>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
